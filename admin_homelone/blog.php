...
if(isset($_POST['title'])){
    ...
    $query="INSERT INTO `blog` (`id`, `photo`, `add_by`, `title`,`details`,`date`,`month`) VALUES (NULL, '$file','$add_by', '$title','$details','$date','$mont')";
    $db->query($query);
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="month" class="form-control" id="exampleInputEmail1" placeholder="Enter Month Name" >
                    </div>
                ...
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$blog->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td>
                              <a href="blog_edit.php?id=<?php echo $data['id'] ?>" class="btn btn-success btn-xs">Edit</a>
                              <a href="bolg_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-danger btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
