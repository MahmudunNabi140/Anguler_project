...
$about_us=$db->query('select * from about_us');
                ...
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$about_us->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td>
                              <a href="about_us_edit.php?id=<?php echo $data['id'] ?>" class="btn btn-success btn-xs">Edit</a>
                              <a href="about_us_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-success btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
