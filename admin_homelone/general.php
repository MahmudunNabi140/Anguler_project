...
if(isset($_POST['email'])){
    ...
    move_uploaded_file($_FILES['logo']['tmp_name'],'../assets/image/'.$file);
    // $footer_logo=$_FILES['footer_logo']['name'];
    // move_uploaded_file($_FILES['footer_logo']['tmp_name'],'../assets/image/'.$footer_logo);
    $query="update general_info set phone='$phone',email='$email',logo='$file',address='$address',website='$website',map='$map'";
    $db->query($query);
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="address" class="form-control" id="exampleInputEmail1" placeholder="Enter Address" value="<?php echo $data['address'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="">Website</label>
                    <input type="text" name="website" class="form-control" id="exampleInputEmail1" placeholder="Enter Website" value="<?php echo $data['website'] ?>">
                  </div>
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="footer_logo" class="custom-file-input" id="exampleInputFile">
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text">Upload</span>
